...
// added volunteer type to avoid dynamic cast in action class
...
public:
    ...
    // added getType() method to volunteer and all subclasses, to avoid dynamic cast
    virtual const VolunteerType getType() const = 0;
...
public:
    ...
    void setTimeLeft();
    const VolunteerType getType() const override;
...
public:
    ...
    string toString() const override;
    const VolunteerType getType() const override; // getVolunteerType
